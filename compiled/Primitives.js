...
const AccentBtn = ({
  ...
  const glow = accent === "spark" ? "0 0 0 1px rgba(214, 243, 95, 0.15), 0 8px 32px rgba(214,243,95,0.22)" : accent === "ember" ? "0 0 0 1px rgba(255, 182, 39, 0.175), 0 8px 32px rgba(255,182,39,0.28)" : "0 0 0 1px rgba(215, 69, 62, 0.15), 0 8px 32px rgba(215, 69, 62,0.25)";
  const sizes = {
    sm: "8px 12px",
    md: "12px 18px",
    lg: "16px 26px"
