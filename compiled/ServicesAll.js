...
if (typeof document !== "undefined" && !document.getElementById("svc-measured-kf")) {
  ...
  _kf.textContent = `
    ...
    @keyframes svcMeasuredTextPulse {
      0%,100% { text-shadow: 0 0 18px rgba(214, 243, 95, 0.175); }
      50%     { text-shadow: 0 0 38px rgba(214, 243, 95, 0.35); }
    }
    @keyframes svcBloomA {
...
/* Category color palette (matches tokens --cat-*), in SITE_SERVICE_GROUPS order. */
const SVC_CAT_HEX = ["#D7453E", "#E68A4C", "#E8C24A", "#9FC24E", "#4FB58A", "#3FAEA8", "#4F7DA6", "#4664C4", "#8A5CD1", "#D6F35F"];
const SVC_LANES = [{
  ...
  sub: "257K+ vetted ambassadors, all 50 states, 48-hour rush.",
  ...
  imgPos: "center 30%",
  meta: ["257K+ roster", "All 50 states", "48-hr rush"]
}, {
...
/* Lane accents follow the category color system (tokens --cat-*), keyed by slug
   through the nav taxonomy so a lane always matches its service-page color. */
(function () {
  const CAT_HEX = ["#D7453E", "#E68A4C", "#E8C24A", "#9FC24E", "#4FB58A", "#3FAEA8", "#4F7DA6", "#4664C4", "#8A5CD1", "#D6F35F"];
  const bySlug = {};
  (window.SITE_SERVICE_GROUPS || []).forEach((g, gi) => (g.services || []).forEach(sv => {
    bySlug[sv.slug] = CAT_HEX[gi];
  }));
  bySlug["fractional"] = bySlug["fractional"] || bySlug["fractional-sales-team"] || "#4664C4";
  bySlug["spark"] = "#D6F35F"; // Spark keeps its lime brand color, not the Reporting category hue
  SVC_LANES.forEach(l => {
    if (bySlug[l.slug]) l.accent = bySlug[l.slug];
  });
})();
...
/* ============================================================
   ALL SERVICES — grouped grid of all 21 specialty pages
============================================================ */
const SVC_GROUPS = [{
  name: "Staffing & Talent",
  accentVar: "var(--ignite-500)",
  items: [{
    slug: "event-staffing",
  ...
  items: [{
    ...
    sub: "In-store demos · Whole Foods · Costco · Target"
  }, {
    ...
    sub: "Brand activations · QSR + casual dining"
  }]
}, {
  ...
  items: [{
    ...
    sub: "Booth staffing · lead capture · on-stand demos"
  }, {
    slug: "distributor-demo-programs",
    label: "Distributor Demo Programs",
    sub: "GSM · ride-along · 3-tier coordinated"
  }, {
...
const ServicesAllGrouped = () => {
  const groups = (window.SITE_SERVICE_GROUPS || []).map((g, gi) => ({
    name: g.name,
    accentVar: SVC_CAT_HEX[gi] || "var(--ignite-500)",
    items: g.services.map(s => ({
      slug: s.slug,
      label: s.label,
      sub: s.sub,
      href: s.href ? s.href.replace(/^pages\//, "") : "/services/" + s.slug
    }))
  }));
  return /*#__PURE__*/React.createElement("section", {
    id: "all-21",
  ...
  }, ">> ", "THE FULL CAPABILITIES MAP"), /*#__PURE__*/React.createElement("h2", {
    style: {
      fontFamily: "var(--font-display)",
      fontWeight: 800,
  ...
  }, "Every lane.", /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("span", {
    style: {
      fontStyle: "italic",
      color: "var(--ignite-500)"
    }
  }, "Every page."))), /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 15,
      lineHeight: 1.55,
      color: "var(--fg-2)",
  ...
  }, "Browse by lane or jump straight to a specialty page. Each lane is a real service we run \u2014 not a website silo.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
    ...
    style: {
      ...
      right: 0,
      height: 3,
      background: `linear-gradient(90deg, ${g.accentVar}, transparent 70%)`
    }
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, String(gi + 1).padStart(2, "0"), " \xB7 LANE"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: "var(--font-mono)",
      fontSize: 10,
      letterSpacing: "0.18em",
  ...
  }, g.items.length, " ", g.items.length === 1 ? "PAGE" : "PAGES")), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontFamily: "var(--font-display)",
      fontWeight: 800,
      fontSize: 22,
...
const SvcLane = ({
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    style: {
      position: "relative",
      padding: "140px 0",
      background: `linear-gradient(${reverse ? "245deg" : "115deg"}, ${s.accent}14 0%, ${s.accent}05 26%, ${i % 2 === 0 ? "var(--ink-000)" : "var(--ink-100)"} 60%)`,
    ...
    style: {
      position: "absolute",
      inset: 0,
      background: "linear-gradient(180deg, #0d0f0a 0%, #07080a 100%)",
      display: "flex",
      flexDirection: "column",
      justifyContent: "space-between",
      padding: 28
...
const ServicesAllPage = () => /*#__PURE__*/React.createElement("div", {
  ...
  active: "SERVICES"
}), /*#__PURE__*/React.createElement(SvcHero, null), /*#__PURE__*/React.createElement(ServicesAllGrouped, null), /*#__PURE__*/React.createElement(SvcIndex, null), SVC_LANES.map((s, i) => /*#__PURE__*/React.createElement(SvcLane, {
  key: s.slug,
  s: s,
  i: i
