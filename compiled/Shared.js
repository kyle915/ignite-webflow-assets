...
const __sparkAssetBase = (() => {
  ...
  return prefix + "https://BASE/assets/";
})();
const assetUrl = name => __sparkAssetBase + name;
const SparkLogomark = ({
  size = 28
}) => /*#__PURE__*/React.createElement("img", {
  src: window.__resources?.r_assets_spark_logomark_pixel_png || "https://BASE/assets/spark-logomark-pixel.png",
  width: size,
  height: size,
  style: {
...
const IgniteWordmark = ({
  ...
  const src = variant === "black" ? window.__resources?.r_assets_ignite_typemark_black_png || "https://BASE/assets/ignite-typemark-black.png" : window.__resources?.r_assets_ignite_typemark_white_png || "https://BASE/assets/ignite-typemark-white.png";
