...
const SERVICES_DATA = {
  "experiential-marketing": {
    ...
    hero: "https://images.unsplash.com/photo-1533174072545-7a4b6ad7a6c3?auto=format&fit=crop&w=2400&q=80",
    sub: [{
...
const SERVICE_EXTRAS = {
  "experiential-marketing": {
    ...
    comparison: [["Rent a footprint. Hand out swag. Post a recap deck.", "Engineer the moment so attendees pull out their phone — unprompted."], ["Sub the build. Sub the staff. Sub the recap. Three vendors, one bill.", "12K sq ft build shop. 257K ambassadors. One platform. One PO."], ["Trust the venue's attendance estimate.", "Spark-tracked dwell, samples, leads, and trial→purchase — same day."], ["Recap deck lands six weeks after the event.", "Live dashboard from hour one. Final recap inside ten days."]],
  ...
  "event-staffing": {
    ...
    pov: {
      lead: "257,000 ambassadors. 50 states.",
